...
const Home = () => {
  ...
  // 투두 삭제 하기
  const handleDeleteTodo = async (todoNo, todoTitle) => {
    if (!window.confirm(`${todoTitle}을 정말 삭제하시겠습니까?`)) {
      return;
    }

    try {
      const result = await todoApi.deleteTodo(todoNo);
              ...
              {todos.map((todo, index) => (
                ...
                >
                  ...
                  <div className="todo-actions">
                    ...
                    <button
                      onClick={() =>
                        handleDeleteTodo(todo.todoNo, todo.todoTitle)
                      }
