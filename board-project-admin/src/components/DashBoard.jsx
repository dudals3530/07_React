...
// 라우팅(Routing) : 사용자가 요청한 URL 경로에 따라 적절한 페이지나 리소스 제공하는 과정 컴포넌트를 제공하는 과정
export default function DashBoard() {
  ...
  const goDashBoardMain = () => {
    // "/" 이동
    // locaion.href = "/"; 사용은 가능하나 권장 X
    // 브라우저의 기본 동작을 이용해서 "새로고침하며 이동" 하는 방식
  ...
  return (
    <div className="dash-board-container">
      ...
      {/* NavLink : 현재 URL이 to 속성과 일치하면 active 상태로 인식
                  Navlink 를쓰게되면 url과 to 가같아지면 active 라는
                  클래스가 추가됨
                  html 상에서 해석될떄 Navlink 는 a 태그로 해석됨
