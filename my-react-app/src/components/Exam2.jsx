...
const Exam2 = (props) => {
  ...
  // 마운트 ., 업데이트 , 언마운트 제어
  // useEffect() : 함수형 컴포넌트에서 렌더링 이후 실행되는 코드
  // (부수 효과)를 작성할 때 사용하는 Hook



  useEffect(() => {
    // 이안의 코드는 컴포넌트가 렌더링 된후 실행됨
  ...
  // 의존성 배열 ([])
  // - > 빈배열을 넣으면 마운트 시 1회 실행 + 언마운트 시 return 구분 1회 실행됨
  ...
  return (
    <div>
      ...
      <h2>
        부모가 준거: {props.youngmin} {props.test}
      </h2>
    </div>
  );
};
